...
<x-partials.page-header title="Tambah Customer" :breadcrumbs="[
...
<div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800" >
    <form action="{{ route('customers.store') }}" method="post">
         @csrf
         <x-form.input name="customer_name" label="Name Customer" />
         <x-form.phone-input name="phone" prefiix-name="phone_prefix" number-name="phone_number" />
         <x-form.text-area name="address" label="Address" />
